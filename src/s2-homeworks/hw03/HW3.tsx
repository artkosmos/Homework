...
export const pureAddUserCallback = (
  name: string,
  setUsers: React.Dispatch<React.SetStateAction<UserType[]>>, // тип, когда функция set в качестве аргумента принимает
  users: UserType[]) => {                                     // новое значение состояния state
  const user = {
    _id: v1(),
    name: name
  }
...
const HW3 = () => {
  ...
  return (
    <div id={'hw3'} className={s2.mainWrapper}>
